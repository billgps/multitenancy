        ...
        <section class="flex flex-col break-words bg-white sm:border-1 sm:shadow overflow-scroll">
            ...
            <div class="w-full p-3">
                <form class="w-full" enctype="multipart/form-data" method="POST"
                    action="{{ route('nomenclature.store') }}">
                    @csrf
                    <div class="w-3/5 sm:px-20 mx-auto">
                        <div class="flex flex-col px-2 mb-4">
                            ...
                            <label class="input-field inline-flex items-baseline border-none shadow-md bg-gray-100 py-2 px-6 ml-2">
                                <div class="flex-1 leading-none">
                                    <input id="name" type="text" class="bg-gray-100 w-full px-2 py-1 outline-none border-none focus:ring-0 text-sm" name="standard_name" placeholder="Name">
                                </div>
                            </label>
                        </div>
                        <div class="flex flex-col px-2 mb-4">
                            ...
                            <label class="input-field inline-flex items-baseline border-none shadow-md bg-gray-100 py-2 px-6 ml-2">
                                <div class="flex-1 leading-none">
                                    <input id="code" type="tel" class="bg-gray-100 w-full px-2 py-1 outline-none border-none focus:ring-0 text-sm" name="aspak_code" placeholder="Kode ASPAK">
                                </div>
                            </label>
                        </div>
                        ...
                        <div class="flex flex-col px-2 mb-4">
                            ...
                            <label class="input-field inline-flex items-baseline border-none shadow-md bg-gray-100 py-2 px-6 ml-2">
                                <div class="flex-1 leading-none">
                                    <textarea id="address" type="text" class="bg-gray-100 w-full px-2 py-1 outline-none border-none focus:ring-0 text-sm" name="keywords" placeholder="Keyword"></textarea>
                                </div>
                            </label>
                        </div>
                    </div>
