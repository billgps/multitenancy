            ...
            <form class="w-3/5 mx-auto pb-6 my-6" method="POST"
                ...
                <div class="sm:grid sm:grid-cols-2 sm:gap-2 sm:px-6">
                    ...
                    <div class="">
                        ...
                        <div class="py-2 text-left">
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="done_date" name="done_date" type="date">
                        </div>
                    </div>
                    <div class="">
                        <label class="block mb-2 text-sm text-gray-00" for="personnel">Personel</label>
                        <div class="py-2 text-left">
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="personnel" name="personnel" type="text" required>
                        </div>
                    </div>
                </div>
