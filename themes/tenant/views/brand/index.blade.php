    ...
    <div class="w-full sm:px-6">
        ...
        <section class="sm:grid sm:grid-cols-6 sm:gap-2 break-words">
            <div class="col-span-6 h-12 flex items-center py-2 px-4 bg-gray-200">
                ...
                @endif 
                <a class="mx-2 text-blue-600 hover:text-gray-400" href="{{ route('brand.export') }}">
            ...
            <div class="flex flex-col sm:col-span-6 break-words bg-white sm:border-1">
                ...
                <div class="w-full px-6 py-3">
                    <table id="brand" class="min-w-max mt-3 w-full table-auto text-center">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal border-b border-gray-600">
                                <th class="py-3 px-6">Nama Merk</th>
                                <th class="py-3 px-6">Asal</th>
                                <th class="py-3 px-6">Ditambahkan Pada</th>
                    ...
                    <script>
                        $(document).ready(function() {
                            ...
                            function drawPaginate() {
                                ...
                                let page = document.getElementById('brand_paginate').getElementsByTagName('span')[0].getElementsByClassName('paginate_button')
