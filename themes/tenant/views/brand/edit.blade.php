                ...
                <div class="sm:grid sm:grid-cols-2 sm:gap-2 sm:px-6">
                    <div class="">
                        ...
                        <div class="py-2 text-left">
                            <input value="{{ $brand->brand }}" class="text-sm bg-gray-200 border-2 border-gray-100 focus:outline-none block w-full py-2 px-4" id="brand" name="brand" type="text" required>
                        </div>
                    </div>
                    <div class="row-start-2">
                        <label class="block mb-2 text-sm text-gray-00" for="origin">Asal</label>
                        <div class="py-2 text-left">
                            <input value="{{ $brand->origin }}" class="text-sm bg-gray-200 border-2 border-gray-100 focus:outline-none block w-full py-2 px-4" id="origin" name="origin" type="text" required>
                        </div>
                    </div>
                </div>
