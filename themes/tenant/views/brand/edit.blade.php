                ...
                <div class="sm:grid sm:grid-cols-2 sm:gap-2 sm:px-6">
                    <div class="flex flex-wrap">
                        ...
                        <div class="relative flex items-center h-10 w-full input-component">
                            <input value="{{ $brand->brand }}" class="border-none outline-none w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="brand" name="brand" type="text" required>
                        </div>
                    </div>
                    <div class="flex flex-wrap">
                        <label class="block mb-2 text-sm text-gray-00" for="origin">Asal Merk</label>
                        <div class="relative flex items-center h-10 w-full input-component">
                            <input value="{{ $brand->origin }}" class="border-none outline-none w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="origin" name="origin" type="text">
                        </div>
                    </div>
                </div>
