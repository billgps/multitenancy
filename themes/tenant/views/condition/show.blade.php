    ...
    <div class="w-full sm:px-6">
        ...
        <section class="flex flex-col break-words bg-gray-200 sm:border-1">
            <div class="col-span-6 h-12 flex items-center py-2 px-4 bg-gray-200">
                <a href="{{ route('condition.edit', ['condition' => $condition->id]) }}" class="mx-2 text-gray-600 hover:text-gray-400 modal-open image-toggle">
                    <i class="fas fa-edit"></i>
                </a>   
                <a href="{{ route('condition.delete', ['condition' => $condition->id]) }}" class="mx-2 text-gray-600 hover:text-gray-400 modal-open image-toggle">
