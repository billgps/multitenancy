    ...
    <div class="w-full sm:px-6">
        ...
        <section class="sm:grid sm:grid-cols-6 sm:gap-2 break-words">
            <div class="col-span-6 h-12 flex items-center py-2 px-4 bg-gray-200">
                @if (Auth::user()->role < 2)
                    <a class="mx-2 text-green-600 hover:text-gray-400" href="{{ route('room.create') }}">
                ...
                @if (Auth::user()->role < 1)
                    ...
                    <div id="import" style="background-color: rgb(31, 41, 55);" class="modal text-gray-200 flex items-center justify-center">
                        <div class="flex justify-between items-center pb-3 text-lg">
                            Import Excel to Room
                        </div>
                        <form action="{{ route('room.import') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="text-xs">
                                <div>
                                    <label class="block mb-2 text-sm text-gray-00" for="file">Rooms</label>
                ...
                @endif 
                <a class="mx-2 text-blue-600 hover:text-gray-400" href="{{ route('room.export') }}">
            ...
            <div class="flex flex-col sm:col-span-6 break-words bg-white sm:border-1">
                ...
                <div class="w-full px-6 py-3">
                    <table id="room" class="min-w-max mt-3 w-full table-auto text-center">
                        <thead>
                    ...
                    <script>
                        $(document).ready(function() {
                            ...
                            function drawPaginate() {
                                ...
                                let page = document.getElementById('room_paginate').getElementsByTagName('span')[0].getElementsByClassName('paginate_button')
